...
% load camera projection matrix (P)
  load('C:\Users\Abi Hogan\Documents\Psychedelics_Internship\behavior_analysis\3D_data_analysis\new_P matrix_abi\Pcal_hogan_cam5notturned_lab.mat', 'P');

% define folder path to folder that contains dlc data from all cameras
  dlc_folder_path = 'C:\Users\Abi Hogan\Documents\Psychedelics_Internship\behavior_analysis\3D_data_analysis\dlc_data_cohort2\';
...
% define mouse file name
  base_name = 'mouse17_extinction_p1';
...
for n = 1 : length(base_names)
    ...
    % save data  
      save(['C:\Users\Abi Hogan\Documents\Psychedelics_Internship\behavior_analysis\3D_data_analysis\triangulated_3D_data\threshold_09_all_mice\' base_names{n} '_3D_triangulated'],"W","X","x","L","TH","camera_files"); 
